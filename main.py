...
async def main():
    ...
    #     symbol=symbol, 
    #     qty=(
    #         settings["SIGNAL_GENERATION"]["max_window_features"] * 5
    ...
    # plot_values_filter_values = g_plot_values(
    #     filter_values_array,
    #     trace_close=True,
    # )
    # fig_filter_values = go.Figure()
    # fig_filter_values.add_trace(go.Scatter(
    #     x=plot_values_filter_values["x_close"],
    #     y=plot_values_filter_values["y_close"],
    #     mode="lines",
    #     name="regime",
    # ))
    # fig_filter_values.show()
    ...
    # fig_balance.add_trace(go.Scatter(
    #     x=plot_values_balances["x_qty"],
    #     y=plot_values_balances["y_qty"],
    #     text=plot_values_balances["text_qty"],
    ...
    ## balance
    # fig_balance.add_trace(go.Scatter(
    #     x=plot_values_balances["x_balance"],
    #     y=plot_values_balances["y_balance"] + plot_values_balances["y_balance"] * 0.02,
    #     mode="text",
    #     text=plot_values_balances["text_balance"],
    # ))
    ...
    # fig_balance.add_trace(go.Scatter(
    #     x=plot_values_balances["x_qty"],
    #     y=plot_values_balances["y_qty"] + plot_values_balances["y_qty"] * 0.02,
    #     mode="text",
    #     text=plot_values_balances["text_qty"],
    # ))
    for annotation, x, y in zip(
    ...
    fig_balance_2.show()
    # fig_balance.write_html(f"plotly_html/{symbol}_kt{settings['BACKTEST']['klines_test']}_{datetime_now}_balance.html")
